...
public class RecycleWeekends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getitems_usingVolley("get_enabled_items", "3", list);
       /*
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PROCESSING,
                        ...
                        try {
                            ...
                            if (response_status.equals("success")) {
                                for (int i = 0; i < jsonArray_response_data.length(); i++) {
                                    ...
                                    eachitem = new itemStore(item_image, item_name, item_price, item_auto_id, "Weekends");
                                    list1.add(eachitem);

                                }
                                adapter1 = new MyRecyclerAdapter(RecycleWeekends.this, list1);
                                rec.setAdapter(adapter1);
                                ...
                                Toast.makeText(RecycleWeekends.this, "No items !!!", Toast.LENGTH_SHORT).show();
                                //Log.v("response", "Invalid Credentials");
                            }
                        } catch (Exception ex) {
                            //show_dialog_message("Network Error", "Check network connection");
                            Toast.makeText(RecycleWeekends.this, "Network Error!!!", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //progressDialog.dismiss();
                        //show_dialog_message("Network Error", "Check network connection");
                        Toast.makeText(RecycleWeekends.this, "Network Error2", Toast.LENGTH_SHORT).show();
