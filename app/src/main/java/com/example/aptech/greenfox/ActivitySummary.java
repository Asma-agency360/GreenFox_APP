    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_printer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                suborder_auto_id = arrayList_sub_orders.get(0).split("#")[0];
                int a=arrayList_sub_orders.size();
                Toast.makeText(ActivitySummary.this, "Item Size"+a, Toast.LENGTH_SHORT).show();
                //suborder_auto_id = arrayList_sub_orders.get(1).split("#")[1];
                getsubordersItems_usingVolley_forPDF("get_sub_orders_items_detail", suborder_auto_id);
                clicked(view);
            }
        });
/*
        File file=new File("/storage/emulated/0/Reciept.pdf");
        if(file.exists())
        {
            file.delete();
            Toast.makeText(ActivitySummary.this, "Deleted", Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(ActivitySummary.this, "Problem in Deleting file", Toast.LENGTH_SHORT).show();
        }
*/
...
/*
    ...
    private void getsubordersItems_usingVolley_forPDF(final String action, final String sub_order_id)
    {
